...
<div style="font-size: 16px;font-weight:bold;text-align:center;padding: 0 0 25px 0;text-shadow:1px 1px 1px #fff">协同办公平台</div><div style="font-size: 12px;text-align:center;padding: 0 0 10px 0;text-shadow:1px 1px 1px #fff">@2012-2016 DzzOffice</div><div style="font-size: 12px;text-align:center;text-shadow:1px 1px 1px #fff">备案信息</div>');
		//添加ftp方式
...
function show_footer() {
	...
	<div id="footer">Copyright © 2012-2016 DzzOffice.com All Rights Reserved.</div>
	</div>
	<br>
	</body>
	</html>
